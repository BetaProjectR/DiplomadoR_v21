...
Mientras que para ejecutar este código, debes presionar **la punta de la flecha verde** que se observa en la parte superior derecha del mismo bloque de códigos.

```{r BOD}
summary(BOD)
```

También puede incluir gráficas en sus bloques de código.
