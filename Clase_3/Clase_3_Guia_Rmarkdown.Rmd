...
Ahora, cree su propio **_script_** para elaborar una presentación usando la barra de herramientas de **Rstudio**. Seleccione **File > New file > R Markdwon** y utilice el siguiente ejemplo para completar la información de **metadatos**: Título, nombre del autor y formato HTML (Slidy).
