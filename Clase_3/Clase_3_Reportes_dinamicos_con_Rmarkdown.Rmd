...
1.- Elaborar reportes dinámicos con Rmarkdown **[Rstudio.Cloud](https://rstudio.cloud/)**.

2.- Instalar librerías con Rstudio.

3.- Importar datos desde excel usando la librería  **readexcel** de  **[tidyverse](https://www.tidyverse.org/)**.
