...
### **Ejercicio 4.** **Filtrar información de la base de datos por algún criterio, en este caso por el año 2017** 
...
### **Ejercicio 6.** **Hacer medidas resumen para la variable ProdNac solo para la Trucha Arcoiris** 
...
### **Ejercicio 7.** **Hacer boxplot con la función ggplot ()** 
...
### **Ejercicio 7.** **Importar la base de Datos2** 
...
### **Ejercicio 8.** **Reemplazar los valores faltantes en la base de datos datos2** 
...
### **Ejercicio 9.** **Genere una nueva variable a partir de la información de otras variables** 

Genere una nueva variable llamada **NTotal** a partir de la suma de los datos de las variables Region_Lagos, Region_Aysen y Region_Magallanes de la base de datos **datos2** generada en el **ejercicio 8**. También, genere una variable llamada **Per_NTotal** que es el porcentaje mensual de casos de ISA confirmados. Use la función **_mutate_**.
...
### **Ejercicio 10.** **Realice un diagrama de barras** 
...
```{r datos2_new}
Datos_new <- datos2_new %>%
  filter(Mes == c("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio"))
