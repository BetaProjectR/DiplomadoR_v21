...
Algunas de estas variables se conocen como **series de tiempo** y en términos estrictos son más bien una *susesión de variables aleatorias* a traves del tiempo.
...
2. Cuando aumenta el N muestral se perfila una distribución llamana **normal**.    
...
[^1]: **IQR =** Rango intercuantil es la diferencia entre el diferencia entre el tercer (75%) y el primer (25%) cuartil de una distribución.
