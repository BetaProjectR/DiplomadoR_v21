...
**d).** Crea un objeto llamado *datos* y almacena en él, el número de elementos del objeto **_rivers_**. A continuación, explora la función del comando **cat** y responde la siguiente pregunta ¿Cuántos elementos o datos tiene el objeto **_rivers_**?
